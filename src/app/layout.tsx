...
export const metadata: Metadata = {
  ...
  keywords: "IT solutions, innovation, tech services",
  metadataBase: new URL("https://www.itcompany.com"),
  alternates: { canonical: "https://www.itcompany.com" },
  openGraph: {
    title: "Innovate with Us",
    description: "Delivering cutting-edge IT solutions tailored for your business.",
    url: "https://www.itcompany.com",
    siteName: "IT Company",
    images: [],
    type: "website"
  },
